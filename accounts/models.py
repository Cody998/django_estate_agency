...
class Users(AbstractBaseUser, PermissionsMixin):
    # id = models.UUIDField(default=uuid.uuid4, primaryKey=True, unique=True editable=False)
    ...
    objects = UserManager() #every important
...
# If you form has anything to do with image of video or file uplOAD, put enctype="multiport/form-data" in the form tag
