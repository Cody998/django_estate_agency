...
SECRET_KEY = 'django-insecure-jp#i0#i+=z*_i8s@tu5!&0-e#^u3y$qkb6$65q99fka!hf^fom'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddlewre',
...
# authenticator for custom user model
